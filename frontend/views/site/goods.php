		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$good->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$good->logo?>" alt="" width="350px"/>
                            <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$good->logo?>',largeimage: '<?=$good->logo?>'}"><img src="<?=$good->logo?>"></a>
								</li>
                                <?php foreach ($gallery as $photo):?>
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$photo->path?>',largeimage: '<?=$photo->path?>'}"><img src="<?=$photo->path?>"></a>
								</li>
                                <?php endforeach;?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="star"><span>商品评分：</span> <strong></strong><span id="views">(已有<?=$good->view_times?>人浏览)</span></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
