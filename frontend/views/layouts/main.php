...
//                        NavBar::end();
//                        ?>
                        <li class="scroll active"><a href="<?=\yii\helpers\Url::to(['site/index'])?>" class="nav">首&emsp;页</a></li>
                        <li class="scroll"><a href="<?=\yii\helpers\Url::to(['site/list2'])?>" style="text-decoration:none;" class="nav">产&emsp;品</a></li>
