...
<!--    <section class="wrapper">-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-laptop"></i> 控制中心</h3>
                <ol class="breadcrumb">
                    <li><i class="fa fa-home"></i><a href="<?=\yii\helpers\Url::to(['site/index'])?>">控制中心</a></li>
<!--                    <li><i class="fa fa-laptop"></i>控制中心</li>-->
                </ol>
            </div>
        </div>
